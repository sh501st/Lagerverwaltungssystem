...
auf dem lokalen Gerät läuft, navigiere zu localhost:8080
...
- Mit dem "Workers" Schieberegler bestimmt man die max. Anzahl an gleichzeitig arbeitenden Mitarbeitern.
- Zum Platzieren eines Regals, klicke mit der linken Maustaste auf ein Feld. Zum Platzieren mehrer Regale ziehe mit gehaltener linker Maustaste über mehrere Felder hinweg. Felder mit platziertem Regal sind blau gefärbt.
- Zum Entfernen eines gesetzten Regals, klicke mit der rechten Maustaste auf entsprechendes Feld bzw. ziehe mit gehaltener rechter Maustaste über mehre Felder hinweg.
...
- Falls alle Regale erreichbar sind, wird nun zum Live View gewechselt, welches ebenfalls über das Hauptmenü zu erreichen ist.
- Um die Planung abzubrechen und zum Hauptmenü zurückzukehren auf "Cancel" klicken.

** Nutzung als Anwender
*** Lager beobachten/Live View
- Um vom Hauptmenü aus zum Live View zu gelgangen, navigiere zu "View Storage". Dort wird das aktuelle Lager angezeigt und Arbeiter visuell dargestellt. Pro Regalzugriff verändert sich die Färbung des Regals, sodass sich eine Heatmap seit Laden der Seite entwickelt. Je kräftiger das Rot ist, desto öfter wurde auf das entsprechende Regal zugegriffen.
...
- Um zum Hauptmemü zurückzukehrenn auf "Cancel" klicken.

\footnotesize

*** Lager optimieren
- Vom Hauptmenü aus gelangt man per Klick auf "Plan Storage" zur Lageroptimierung. Dort wird das aktuelle Lager angezeigt mit aktueller (rot) und optimierter (grün) Sortierung. Es wird automatisch zwischen beiden Zuständen gewechselt.
...
- Zum Umsetzen des geplanten Lagers auf "Optimize" klicken. Es wird ein optimiertes Lager generiert, zu dessen Live View weitergeleitet wird.
